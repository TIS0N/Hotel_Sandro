            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href=<?php echo "$includePath/inc/help.php"?> class="navbar-brand">Help</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href=<?php echo "$includePath/inc/registration.php"?> class="navbar-brand">Registration</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href=<?php echo "$includePath/inc/login.php"?> class="navbar-brand">Log in</a>
                        </li>
                        <li class="nav-item">
