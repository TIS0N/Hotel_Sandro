    ...
    <div class="container text-start">
        <div class="row align-items-starts">
            <div class="col">
                ...
                <h2>Home</h2>
                <img src="./res/img/hotel.jpg" alt="Photo of Hotel Sandro Wien">
            </div>
