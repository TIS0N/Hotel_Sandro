...
<body>
    ...
    ?>
     <section class="changePassword-form">
            ...
            <div class="row align-items-end">
                <div class="col-ms-4">
                    <form role="form" action="../inc/changePassword.inc.php" method="post">
                        ...
                        <button class="btn btn-lg btn-light btn-block" type="reset" name="reset">Clear</button>
                        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Change</button><br><br>
