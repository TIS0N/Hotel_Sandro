                ...
                <div class="accordion" id="accordionQuestions">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body">
                            <strong>Answer.</strong> Payment is not required online, there is only an option to reserve your room online an to set a date for when exactly.
                        </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-body">
                            <strong>Answer.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
                        </div>
                        </div>
                    </div>
                    <div class="accordion-item">
