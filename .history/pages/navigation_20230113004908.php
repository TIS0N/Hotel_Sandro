...
-->
                        ...
                        if(isset($_SESSION["useruid"])){
                            echo "<li class='nav-item'><a class='nav-link' href=" . "$includePath/profile.php" . " class='navbar-brand'>Profile</a></li>";
                            echo "<li class='nav-item'><a class='nav-link' href=" . "$includePath./inc/logout.inc.php" . " class='navbar-brand'>Log out</a></li>";
                        }else{
                            echo "<li class='nav-item'><a class='nav-link' href=" . "$includePath/registration.php" . " class='navbar-brand'>Registration</a></li>";
                            echo "<li class='nav-item'><a class='nav-link' href=" . "$includePath/login.php" . " class='navbar-brand'>Log in</a></li>";
                        }
                        ?>
