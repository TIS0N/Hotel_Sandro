...
?>
    ...
    <div id="formular" class="container text-center col-8">
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <br><div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <label for="lname" class="col-sm-3 col-form-label"><strong>Family Name</strong></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="lname" placeholder="Cena">
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="username" class="col-sm-3 col-form-label"><strong>Username</strong></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="username" placeholder="Johny1234">
                        </div>
                    </div>
            ...
            <div class="col-6">
                <br><div class="row mb-4">
                    <label for="email" class="col-sm-3 col-form-label"><strong>Email</strong></label>
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="email" placeholder="johny.1234@gmail.com">
                        </div>
                </div>
                <div class="row mb-4">
