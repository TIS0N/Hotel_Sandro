                                    ...
                                    <fieldset class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="radio" name="gender" id="male" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="male" checked>
                                                <label class="form-check-label" for="male"><strong>Male</strong></label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gender" id="female" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female" checked>
                                                <label class="form-check-label" for="female"><strong>Female</strong></label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gender" id="other" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="other" checked>
