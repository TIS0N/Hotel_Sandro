...
$fname = $lname = $username = $email = $password = $password2 = $gender = "";
$empty_input_error = "Please fill in all the required fields!";
$fnameErr = $lnameErr = $usernameErr = $emailErr = $passwordErr = $password2Err = $genderErr = "";
?>
<!DOCTYPE html>
<html lang="en">
<head>
                            ...
                            <div class="container text-center">
                                ...
                                <div class="col">
                                    ...
                                    <label for="email" class="col-sm-3 col-form-label"><strong>Email:</strong><span class="error" style="color: rgb(255, 94, 94);">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" id="usersEmail" name="usersEmail" placeholder="sandro.1234@gmail.com">
